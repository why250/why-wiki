...
$$SFDR\left(\frac{R_{LSB}}{R_{load}}, N\right) \approx \frac{(R_{LSB}/R_{load})^2}{2^{2(N-2)}} \equiv 20\log(R_{LSB}/R_{load}) - 6(N-2) \text{ [dB]}$$
 (10)
